...
public class AccountDAO {
    ...
    public static void main(String[] args) {
         Account acc = Account.builder().accountPassword("1").accountEmail("An").build();
         System.out.println(register(acc));
        System.out.println(AccountDAO.getOneByEmail("Vulinh"));
    }

    public static int register(Account obj) {
        int check = 0;
    ...
    public static Account getOneByEmail(String email) {
